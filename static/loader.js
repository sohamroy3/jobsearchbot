"use strict";
        ...
        pmTheme: "https://parramato.com/bot-view/myproject_100911645983/dev/css/theme.css"
    });
    loadJs({
        ...
        script: "https://parramato.com/bot-view/myproject_100911645983/dev/js/script.js",
    });
                window.jubiModal={
                static:{
                ...
                window.leftpanel =  '<div class="leftPage" id="leftpanel">'+                        
  '<div class="leftContent">'+                           
      '<div class="jubi-message">'+
          '<h1 id="boldmsg-1">Hello,</h1>'+
          '<h2 id="boldmsg-2">Delight</h2>'+

          '<div class="jubi-text" id="msgDescribe" style="">'+
...
'</div>';   
  ...
  '</section>' +       
'</section>';
                window.loadPermissionView = '<section id="pm-permission-view" style="display:none" >'+
